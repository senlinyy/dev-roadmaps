...
overview: "ML API request design turns a model call into a contract between product services and the serving team. This article follows a delivery ETA service and shows request fields, response fields, schema versions, batch payloads, error bodies, and review checks."
tags: ["MLOps", "core", "api"]
order: 2
...
2. [Follow One Delivery ETA API](#follow-one-delivery-eta-api)
...
## Follow One Delivery ETA API
<!-- section-summary: The running example predicts food delivery arrival time for a product service that needs a fast, explainable response. -->
