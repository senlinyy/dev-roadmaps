...
1. [Rollback Restores a Known-Good Decision Path](#rollback-restores-a-known-good-decision-path)
2. [Understand What a Rollback Can Undo](#understand-what-a-rollback-can-undo)
3. [Give the Rollback Target a Complete Identity](#give-the-rollback-target-a-complete-identity)
4. [Prepare the Recovery Path Before Release](#prepare-the-recovery-path-before-release)
5. [Connect Triggers to Authorized Actions](#connect-triggers-to-authorized-actions)
6. [Separate Containment, Rollback, and Recovery](#separate-containment-rollback-and-recovery)
7. [Choose Rollback or Forward Fix](#choose-rollback-or-forward-fix)
8. [Roll Back an Online Decision Service Safely](#roll-back-an-online-decision-service-safely)
9. [Understand Registry, Deployment, and Traffic Controls](#understand-registry-deployment-and-traffic-controls)
10. [Protect Feature, Schema, and Policy Compatibility](#protect-feature-schema-and-policy-compatibility)
11. [Account for Caches, In-Flight Work, and State](#account-for-caches-in-flight-work-and-state)
12. [Recover Batch Predictions as Versioned Data](#recover-batch-predictions-as-versioned-data)
13. [Verify Recovery From Control to Product Outcome](#verify-recovery-from-control-to-product-outcome)
14. [Repair Decisions That Already Left the Model](#repair-decisions-that-already-left-the-model)
15. [Reconcile GitOps and the Release Record](#reconcile-gitops-and-the-release-record)
16. [Practice the Entire Recovery Path](#practice-the-entire-recovery-path)
17. [The Main Idea](#the-main-idea)
18. [References](#references)

## Rollback Restores a Known-Good Decision Path
...
## Understand What a Rollback Can Undo
...
## Give the Rollback Target a Complete Identity
...
## Prepare the Recovery Path Before Release
...
### Retain and test the stable path
...
### Make the active version observable
...
## Connect Triggers to Authorized Actions
...
## Separate Containment, Rollback, and Recovery
...
### Freeze and identify the live state
...
## Understand Registry, Deployment, and Traffic Controls
...
## Protect Feature, Schema, and Policy Compatibility
...
## Account for Caches, In-Flight Work, and State
...
## Recover Batch Predictions as Versioned Data
...
## Verify Recovery From Control to Product Outcome
...
## Repair Decisions That Already Left the Model
...
## Reconcile GitOps and the Release Record
...
## Practice the Entire Recovery Path
...
A useful drill activates a non-production or low-risk candidate, triggers containment, restores the approved release bundle, verifies loaded versions, checks cache behavior, and reconciles Git. Batch drills should produce a bad test run, quarantine it, create a correction run, and resume a test consumer without duplication.
