...
`VmRSS` is the same number `ps` reports. `VmSwap` shows how much of this process has been paged out, useful when you want to know which process is taking the swap hit alongside its RAM use.
