...
The grader requires you to use `cd`, `cat`, and `grep`, finishes in `/var/log/aws`, and checks that your combined output mentions `sg-0a1b2c3d`, `FromPort: 22`, `FromPort: 443`, `8080`, and `Egress`.
